        ...
        findViewById(R.id.lobby_mode_first).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isModeSelected!=2) {
                    ...
                    findViewById(R.id.lobby_mode_first).setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.button_state));
                    findViewById(R.id.lobby_mode_two).setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(),R.color.button_state_gray));
                }
        ...
        findViewById(R.id.lobby_mode_two).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isModeSelected!=1) {
                    ...
                    findViewById(R.id.lobby_mode_first).setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(), R.color.button_state_gray));
                    findViewById(R.id.lobby_mode_two).setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(),R.color.button_state));
                }
