...
public class FetchProfile extends AsyncTask<Integer, Void, String> {
    public Context ctx;
    public String JSON_String;
    JSONObject jsonObject;
    JSONArray jsonArray;
    Profile profile;
    String json_url ="https://desocialize.000webhostapp.com/getprofilepage.php";

    public FetchProfile( Context ctx){
        this.ctx = ctx;
    }
